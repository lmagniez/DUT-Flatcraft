...
public abstract class ColonneDeRessources extends JButton implements ActionListener {
    ...
    /**
     * Cr�� en fonction de la profondeur et de mani�re al�atoire un ensemble de RessourceInstance 
     */
    private void create() {
        float r;
        int i;
    ...
    /**
     * D�poser et creuser 
     * Si on appui sur CTRL avec le clic sur la case, on d�pose
     * Sinon, on creuse (r�cup�re ressourceContainer dans l'inventaire)
     * 
     * DEPOSER:
     * Si on d�pose la derni�re ressource, le ressourceContainer disparait
     * 
     * CREUSER:
     * Si on creuse dans la lave, l'outil �quip� se brise
